...
export const RESET_NEW_OPTION = 'RESET_NEW_OPTION';
export const ADD_OPTION_IN_POLL = 'ADD_OPTION_IN_POLL';
export const ADD_OPTION_IN_POLL_SUCCESS = 'ADD_OPTION_IN_POLL_SUCCESS '
export const ADD_OPTION_IN_POLL_REQUEST = 'ADD_OPTION_IN_POLL_REQUEST'